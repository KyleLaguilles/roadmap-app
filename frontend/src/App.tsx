            ...
            <section className="space-y-3">
              <div>
                ...
                <p className="text-slate-400 text-sm mt-1">
                  Based on your completed coursework and goals, prioritize these.
                </p>
              </div>
              <div className="flex flex-wrap gap-2">
                {result.electives.map((course) => (
                  <span
                    key={course}
                    className="inline-flex items-center rounded-full border border-amber-400/30 bg-amber-400/10 px-4 py-1.5 text-sm font-medium text-amber-300"
                  >
                    {course}
                  </span>
                ))}
